...
const client = makeWASocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC Simple By Jacky", "Dekstop", "3.0"]})
console.log(color('[ SC BY JACKY-MD ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : JACKY-MD\n➸ Creator : JACKY\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : Jacky-MD OFFICIAL`\n➸ My Instagram : @jackystore5758\n\nDonase Me For Support :\n➸ DONASI : https://saweria.co/Jacky\n\nThanks\n', 'red'))
